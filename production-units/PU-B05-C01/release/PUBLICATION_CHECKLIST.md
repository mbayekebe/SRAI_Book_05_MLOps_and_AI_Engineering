# Publication Checklist — PU-B05-C01

## Content and pedagogy

- [x] Controlled lesson is 40–44 pages (42 pages).
- [x] Native Word equations are present.
- [x] Assessment questions, exercises and instructor solutions are present.
- [x] Agriculture, Education, Health and Habitat applications are included.
- [x] Executive brief and presentation are included.
- [x] Presentation narration is stored in speaker notes.

## Technical validation

- [x] Notebook executes in VS Code.
- [x] Notebook executes in Google Colab.
- [x] Notebook uses public dependencies only.
